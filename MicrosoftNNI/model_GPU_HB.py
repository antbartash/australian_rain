...
def run(X_train, y_train, model):
    ...
    for rowid in iterations.index:
        metrics = {
            ...
            'MCC': iterations.loc[rowid, 'learn'][1] # AUC is not implemented on GPU
        }
...
if __name__ == '__main__':
    ...
    try:
        # using n_estimators as the trial_budget
        RECIEVED_PARAMS = nni.get_next_parameter()
        RECIEVED_PARAMS['n_estimators'] = RECIEVED_PARAMS['TRIAL_BUDGET']*50
        del RECIEVED_PARAMS['TRIAL_BUDGET']
